...
<div class="container">
    <div class="alert alert alert-primary" role="alert" style="padding: 1%;">
            <h4 class="text-center" style="color:aliceblue;">GUESS THE OBJECT</h4>
    </div>
    <!-- add/edit form modal -->
    <?php
    include_once 'common_files/popup_form_2img_2.php';
    ?>
    ...
    <!-- table -->
    <?php
    include_once 'common_files/rows_area_gto.php';
    ?>
    <!-- table -->
    <nav id="pagination">
    </nav>
