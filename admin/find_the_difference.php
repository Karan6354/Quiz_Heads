...
<div class="container">
    <div class="alert alert alert-primary" role="alert" style="padding: 1%;">
            <h4 class="text-center" style="color:aliceblue;">FIND THE DIFFERENCE</h4>
    </div>
    <!-- add/edit form modal -->
    <?php
    include_once 'common_files/popup_form_2img.php';
    ?>
    ...
    <!-- table -->
    <?php
    include_once 'common_files/rows_area_ftd.php';
    ?>
    <!-- table -->
    <nav id="pagination">
    </nav>
