      ...
      <form id="addform" method="POST" enctype="multipart/form-data">
        <div class="modal-body">
          ...
          <div class="custom-file">
            ...
            <label class="custom-file-label" for="userphoto" style="color: black;background-color:blueviolet;">Display Image</label>
            <input type="hidden" name="hp1" id="photo1" value="">
          
          </div>
          <div class="custom-file">
            <input type="file" class="custom-file-input" name="photo2" id="questionphoto2">
            <label class="custom-file-label" for="userphoto" style="color: black;background-color:blueviolet;">Full Image</label>
            <input type="hidden" name="hp2" id="photo2" value="">
          </div>
          <div class="form_group">
            <input type="input" class="form_field" placeholder=" " value="" name="answer" id="answer" style="color: blueviolet;">
            <label for="name" class="form_label" id="q_answer">Answer</label>
          </div>
        </div>
