...
$connect = new PDO("mysql:host=localhost; dbname=qh_db1", "root", "");
...
if (isset($_POST["register"])) {
	...
	if ($error_user_email == '' && $error_user_password == '') {
		...
		$query = "update user_master set activate_User = '" . $user_activation_code . "',user_Otp='" . $user_otp . "' WHERE u_email = '" . $user_email . "' ";
		...
		if ($statement->rowCount() == 0) {
			...
			// "."<p>"."Sincerely,"."</p>
			// ";
			$body = "To verify your email address, enter this verification code when prompted : \n\n". $user_otp . "\n\nSincerely, Quiz Heads";
			$sender = "From:quizheads0229@gmail.com";
